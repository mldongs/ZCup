...
{
	import com.zcup.display.IMovie;
	 ...
	 * @desc: 用于位图渲染
	 */
	public class AbstractBitmapMovie extends TimerMovie implements IMovie
	{
		...
		public function AbstractBitmapMovie(timer:Timer = null)
		{
			super();
			
			if(timer == null)
			{
				throw new Error("必须在子类初始化timer!");
			}
		...
		public function play(delay:int=0):void
		{
			if(delay>0)
			{
				var delayTimer:Timer = new Timer($timer.delay*delay,1);
